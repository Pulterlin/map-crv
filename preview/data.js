...
export const places = [
  ...
  {id:'rear',name:'A栋后穿堂',short:'后',kind:'dock',subtitle:'17–26号/27–30号两组',x:45,z:0,y:3,photo:'A栋1楼后穿堂.jpg',description:'17号从洗筐区端起向B栋方向递增。17–26号与27–30号按现场标注分为两组。',tags:['17–26号','27–30号'],groups:['rear']},
  ...
  {id:'gate',name:'西北门',short:'门',kind:'service',subtitle:'园区主入口',x:-133,z:24,y:14,description:'德信昌科技园西北侧入口，点击此处可快速将地图镜头移到大门。',tags:['主入口','西北侧']},
